...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЦентрМониторингаОтраслевой.НастроитьЭлементыФормыПараметровЦентраМониторинга(ЭтотОбъект);
...
Процедура УстановитьПараметрыЦентраМониторинга(НовыеПараметры)
	...
	// ЦентрМониторингаОтраслевой
	ЦентрМониторингаОтраслевой.РегистрацияАвтораИзмененияКонтактнойИнформации(НовыеПараметры);
	// Конец ЦентрМониторингаОтраслевой
