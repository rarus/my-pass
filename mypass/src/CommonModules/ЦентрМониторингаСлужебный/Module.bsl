...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	// ЦентрМониторингаОтраслевой
	Обработчик = Обработчики.Добавить();
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Процедура = "ЦентрМониторингаОтраслевой.ПриОбновленииИнформационнойБазы";
	...
	Обработчик.Версия = "*";
	Обработчик.Процедура = "ЦентрМониторингаОтраслевой.ПриОбновленииИнформационнойБазы";
	// Конец ЦентрМониторингаОтраслевой
...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	// ЦентрМониторингаОтраслевой
	ЦентрМониторингаОтраслевой.ПриДобавленииПараметровРаботыКлиентаПриЗапуске(ПараметрыРаботыКлиента, Параметры);
	// Конец ЦентрМониторингаОтраслевой
...
Процедура ПриПериодическомПолученииДанныхКлиентаНаСервере(Параметры, Результаты) Экспорт
	...
	// ЦентрМониторингаОтраслевой
	ЦентрМониторингаОтраслевой.ПриВыполненииСтандартныхПериодическихПроверокНаСервере(Параметры);
	// Конец ЦентрМониторингаОтраслевой
...
Процедура ЦентрМониторингаРегламентноеЗадание() Экспорт
	...
	Если (ПараметрыЦентраМониторинга.ВключитьЦентрМониторинга ИЛИ ПараметрыЦентраМониторинга.ЦентрОбработкиИнформацииОПрограмме) И ЭтоГлавныйУзел() Тогда 
		...
		// ЦентрМониторингаОтраслевой
		ЦентрМониторингаОтраслевой.ПриСбореПоказателейСтатистикиКонфигурации(ПараметрыЦентраМониторинга, ДатаЗапуска, НеобходимаЗаписьОценкиПроизводительности);
		// Конец ЦентрМониторингаОтраслевой
...
#Область СекцияStatisticsConfiguration
	Если ПараметрыЦентраМониторинга.РегистрироватьСтатистикуКонфигурации И ОтправлятьСтатистикуКонфигурации Тогда
		Если РазделениеПоОбластямДанныхВключено Тогда
			...
			Пока Выборка.Следующий() Цикл
				...
				Если РегистрыСведений.ОбластиСтатистики.СобиратьСтатистикуКонфигурации(ОбластьДанныхСтрока) Тогда
					// ЦентрМониторингаОтраслевой
					РезультатЗапроса = ЦентрМониторингаОтраслевой.ПолучитьСтатистикуИспользованияОбъектовБазыДанных(ОбластьДанныхСсылка, ТаблицаЗначенийИмена);
					// Конец ЦентрМониторингаОтраслевой
		...
		Иначе
			// ЦентрМониторингаОтраслевой
			РезультатЗапроса = ЦентрМониторингаОтраслевой.ПолучитьСтатистикуИспользованияОбъектовБазыДанных();
			// Конец ЦентрМониторингаОтраслевой
...
Процедура СформироватьПакетДляОтправки()
	...
	Попытка
		...
		// ЦентрМониторингаОтраслевой
		ЦентрМониторингаОтраслевой.ПриФормированииПакетаДляОтправки(JSONСтруктура, ПараметрыЦентраМониторинга, ТекДата, Параметры.ДатаНачала, Параметры.ДатаОкончания, Параметры.ПериодУдаления);
		// Конец ЦентрМониторингаОтраслевой
...
Функция ПолучитьПараметрыПоУмолчанию()
	...
	// ЦентрМониторингаОтраслевой
	ЦентрМониторингаОтраслевой.ПриПолученииПараметровПоУмолчанию(ПараметрыКонстанты);
	// Конец ЦентрМониторингаОтраслевой
...
Функция УстановитьПараметрыОтправки(Параметры)
	...
	// ЦентрМониторингаОтраслевой
	ЦентрМониторингаОтраслевой.ПриПолученииПараметровОтСервера(Параметры, ПараметрыОтправки);
	// Конец ЦентрМониторингаОтраслевой
...
Процедура ЗаписатьДанныеСКлиентаУникальные(Замеры, ТипЗаписи, ТекДата)
	...
	Для Каждого ТекЗамер Из Замеры Цикл
		...
		// ЦентрМониторингаОтраслевой
		ЦентрМониторингаОтраслевой.ПриПолученииПараметровЗаписиОперацииБизнесСтатистики(ПараметрыЗаписи, ТипЗаписи, ТекЗамер, ТекДата);
		// Конец ЦентрМониторингаОтраслевой
...
Процедура ОтправитьТестовыйПакет(ПараметрыВыполнения, АдресРезультата) Экспорт
	...
	// ЦентрМониторингаОтраслевой
	ЦентрМониторингаОтраслевой.ПередОтправкойОзнакомительногоПакета(ПараметрыВыполнения, ДатаЗапуска, ПараметрыЦентраМониторинга);
	// Конец ЦентрМониторингаОтраслевой
